...
class Thread extends React.Component {
    render() {
        ...
        const lepLink = this.props.lastPost ? (<li><Link to={applyRoot(`threads/${this.props.thread.id}/page/${this.props.lastPost.page_num}`)}>Last Extracted</Link></li>) : null;
        return (
            <tr>
                <td><Link to={applyRoot(`threads/${this.props.thread.id}/page/1`)}>{this.props.thread.id}</Link></td>
